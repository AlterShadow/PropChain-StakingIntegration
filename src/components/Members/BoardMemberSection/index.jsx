...
const BoardMemberSection = () => {
  ...
  const [depositAmountNumber, setDepositAmountNumber] = useState(1000);
          ...
          <div className='brick-circle-container bg-sec-100 d-flex align-items-center justify-content-center'>
            ...
            <div className='star-container d-flex align-items-center justify-content-center'>
              ...
              <div className='text-center position-relative'>
                <div className='text-pri-400 xp-number'> 16 </div>
        ...
        <div className='d-flex align-items-end peer-board-members'>
          <div className='d-flex align-items-md-center flex-column flex-md-row'>
            ...
            <div className='d-flex peer-member-image-container'>
              <img src={MemberImage} alt='' className='peer-member-image' />
              <img src={MemberImage} alt='' className='peer-member-image' />
              <img src={MemberImage} alt='' className='peer-member-image' />
              <img src={MemberImage} alt='' className='peer-member-image' />
              <img src={MemberImage} alt='' className='peer-member-image' />
      ...
      >
        ...
        <div className='box d-flex align-items-center'>
          ...
          <div>
            ...
            <div className='label'> Referal Points </div>
          </div>
        </div>
        ...
        <div className='box d-flex align-items-center'>
          ...
          <div>
            ...
            <div className='label'> Poll Count </div>
          </div>
        </div>
      </MotionDiv>
      ...
      <div className='row'>
        <div className='col-12 col-xl-8'>
          ...
          >
            ...
            <div className='text-sec-400 dot-number' style={{ marginLeft : `${newsArr.length * 20 + 5}px` }}>
              {newsIndex + 1} / {newsArr.length}
            </div>
          </MotionDiv>
        </div>
        <div className='col-12 col-xl-4 flex-grow-1 d-flex flex-column'>
          <MotionDiv
            className='xp-card h-100 d-flex flex-column justify-content-center'
            transition={{ delay : 0.8, duration : 0.7 }}
          >
            <PollBg className='poll-bg' />

            <div className='earn-xp-badge'>
              <i className='pc-icon pc-icon-bolt pc-icon-size-16 margin-right-6' />
              Earn 2XP
            </div>

            <div className='vote-and-eard-badge'>
              Vote and Earn
            </div>

            <div className='title'>
              What should the PROPC token be used for?
            </div>
